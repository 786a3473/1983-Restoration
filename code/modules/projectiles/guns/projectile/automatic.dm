...
/obj/item/weapon/gun/projectile/automatic/rpk74
	...
	load_method = MAGAZINE
	magazine_type = /obj/item/ammo_magazine/c762x39r
...
/obj/item/weapon/gun/projectile/automatic/m14/scoped
	...
	firemodes = list(
		list(mode_name="semiauto",       burst=1, fire_delay=0,    move_delay=null, requires_two_hands=3, burst_accuracy=null, dispersion=null),
		list(mode_name="short bursts",	burst=4, move_delay=8, requires_two_hands=10, burst_accuracy = list(0,-3,-6,-8,-10),          dispersion = list(1.0, 1.5, 2.0, 3.0, 4.0)),
		list(mode_name="long bursts",	burst=6, move_delay=10, requires_two_hands=10, burst_accuracy = list(0,-3,-6,-8,-10), dispersion = list(1.0, 1.5, 2.0, 3.0, 4.0)),
		)
