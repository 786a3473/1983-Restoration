...
/area/coldwar/outside
	...
	icon_state = "outside"
	sound_env = PLAIN
	forced_ambience = list('sound/effects/wind/windloopoutdoors.wav')
	ambience = list (
	...
	'sound/ambience/coldwar/snowstorm_outdoor_loop1.wav'
	)
/area/coldwar/forest
	name = "forest"
	icon_state = "forest"
...
/area/coldwar/civdef
	...
	ambience = list('sound/ambience/coldwar/creepyamb1.wav','sound/ambience/coldwar/creepyamb2.wav','sound/ambience/coldwar/creepyamb3.wav')
	forced_ambience = list('sound/ambience/coldwar/electrichum.wav')

/area/coldwar/house1
	name = "house"
	icon_state = "house"
	forced_ambience = list('sound/effects/wind/windloopindoors.wav')
